...
<%
		...
		%>
		<button class="btn btn-outline-danger" name="delete" type="submit" value="delete"><i class="far fa-trash-alt"></i></button>
		<button class="btn btn-outline-dark"name="update" type="submit" value="update"><i class="fas fa-edit"></i></button>
	</form>
</body>
</html>